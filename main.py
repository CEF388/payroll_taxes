...
bordro=st.checkbox("Bordrolu Çalışan Mısınız?",value=True)
gelir=st.number_input("Yıllık Brüt Gelirinizi Giriniz:",min_value=0,value=0,step=1000)
...
net=round(gelir-vergi,2)
ay=round(gelir/12,2)
aynet=round(net/12,2)
